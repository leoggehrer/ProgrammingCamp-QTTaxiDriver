...
namespace QTTaxiDriver.Logic.DataContext
{
    ...
    {
#if SQLSERVER_ON
        private static readonly string ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Database=QTTaxiDriverDb;Integrated Security=True";
#endif
#if SQLITE_ON
        private static readonly string ConnectionString = "Data Source=/Users/gerhardgehrer/Projects/Data/QTTaxiDriver.db";
#endif
        /// <summary>
